...
public class Recipes
{
	...
	{
		GameRegistry.addRecipe(new ItemStack(Items.redstoneChip), "RRR", "IRI", "RRR", 'R', net.minecraft.init.Items.redstone, 'I', net.minecraft.init.Items.iron_ingot);
		GameRegistry.addRecipe(new ItemStack(Items.ironChip), "RRR", "IRI", "RRR", 'R', net.minecraft.init.Items.redstone, 'I', Items.redstoneChip);
